...
class Pessoas(models.Model):
    ...
    fone_res = models.CharField(max_length=15, blank=True, unique=True) # Telefone resindencial, somente numeros
    ...
    perfil = models.IntegerField(blank=False,choices=PERFIS_CHOICES)
